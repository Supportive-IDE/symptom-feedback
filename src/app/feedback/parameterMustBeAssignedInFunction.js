...
export default function ParamMustBeAssignedInFunction({misconInfo}) {
    ...
    return <>
        ...
        <h2>How to fix?</h2>
        <p>Avoid setting the value of a parameter inside a function, at least before the parameter has been used in the function. This will allow the code that calls the function 
