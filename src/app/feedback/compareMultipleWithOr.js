...
export default function CompareMultipleWithOr({misconInfo}) {
    ...
    return <>
        ...
        <p><CodeInline code={compareOr.booleanExpressionText} /> is a <strong>compound boolean expression</strong>. A boolean expression is an expression that  
        is <CodeInline code="True" /> or <CodeInline code="False" />, and a <strong>compound</strong> boolean expression is made up of two or more simple boolean expressions 
